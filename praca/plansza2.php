...
function glowna()
{
	...
	for(i=0; i<y; i++)
	{
		for(j=0; j<x; j++)
		{
			...
			document.getElementById("pole"+i+"."+j+"").style.width="23%";
			document.getElementById("pole"+i+"."+j+"").style.height="23%";
...
function sprawdz()
{
	...
	for(i=0; i<y; i++)
	{
		if(tab[i][0]==ja && tab[i][1]==ja && tab[i][2]==ja)
		{
			win++;
			koniec=(i*y)+","+(i*y+1)+","+(i*y+2)+",";
		}
		if(tab[0][i]==ja && tab[1][i]==ja && tab[2][i]==ja)
		{
			win++;
			koniec=i+","+(y+i)+","+(y*2+i)+",";
		}
		if(tab[i][1]==ja && tab[i][2]==ja && tab[i][3]==ja)
		{
			win++;
			koniec=(i*y+1)+","+(i*y+2)+","+(i*y+3)+",";
		}
		if(tab[1][i]==ja && tab[2][i]==ja && tab[3][i]==ja)
		{
			win++;
			koniec=(y+i)+","+(y*2+i)+","+(y*3+i)+",";
		}
	}
	if(tab[0][0]==ja && tab[1][1]==ja && tab[2][2]==ja)
	{
		win++;
		koniec="0,5,10,";
	}
	else if(tab[1][1]==ja && tab[2][2]==ja && tab[3][3]==ja)
	{
		win++;
		koniec="5,10,15,";
	}
	else if(tab[0][1]==ja && tab[1][2]==ja && tab[2][3]==ja)
	{
		win++;
		koniec="1,6,11,";
	}
	else if(tab[1][0]==ja && tab[2][1]==ja && tab[3][2]==ja)
	{
		win++;
		koniec="4,9,14,";
	}
	else if(tab[2][0]==ja && tab[1][1]==ja && tab[0][2]==ja)
	{
		win++;
		koniec="8,5,2,";
	}
	else if(tab[3][0]==ja && tab[2][1]==ja && tab[1][2]==ja)
	{
		win++;
		koniec="12,9,6,";
	}
	else if(tab[2][1]==ja && tab[1][2]==ja && tab[0][3]==ja)
	{
		win++;
		koniec="9,6,3,";
	}
	else if(tab[3][1]==ja && tab[2][2]==ja && tab[1][3]==ja)
	{
		win++;
		koniec="13,10,7,";
	}
